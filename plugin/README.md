...
Details: [docs/install-analytics.md](https://github.com/imsai-sh/dsh-1024store/blob/main/web/docs/install-analytics.md).
...
```sh
DSH_HOME=/tmp/dsh-store-test dsh plugin --profile market-test add ./plugin
