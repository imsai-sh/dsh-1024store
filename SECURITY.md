...
- The Worker's public API surface is documented in [docs/api.md](docs/api.md); the anonymous install telemetry the `dsh1024` CLI emits is documented in [docs/install-analytics.md](docs/install-analytics.md).
