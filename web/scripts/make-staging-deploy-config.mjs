...
// ids are already declared publicly in web/wrangler.jsonc). Only two things
...
// Worker afterwards so both behave identically (see web/docs/deployment.md).
//
// Usage (after `npm run build --workspace @dsh-1024store/web`):
//   node web/scripts/make-staging-deploy-config.mjs
